...
Inara = User.create!(
  ...
  fname:'Inara', 
  lname:'Serra', 
  image: URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Inara-Firefly.jpg')
  )
...
Helga = User.create!(
  ...
  fname:'Helga', 
  lname:'Hufflepuff', 
  image: URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Helga-Hufflepuff.jpg')
  )
...
Vin = User.create!(
  ...
  fname:'Vin', 
  lname:'Lady Mistborn', 
  image: URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Ellen_Page.jpg')
  )
...
Albus = User.create!(
  ...
  fname:'Albus', 
  lname:'Dumbledore', 
  image: URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Dumbledore.jpg')
  )
...
item1 = Item.create!(
  ...
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_1.jpg')
)
...
item2 = Item.create!(
  project_id: glass1.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_1D1.jpg')
)

item3 = Item.create!(
  project_id: glass1.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_2.jpg')
)

item4 = Item.create!(
  project_id: Project.last.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_2D2.jpg')
)

item5 = Item.create!(
  project_id: Project.last.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_3.jpg')
)

item6 = Item.create!(
  project_id: glass1.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/Glasswave_3D2.jpg')
)
# project 2
arch = Project.create!(
  title:'Architecture', 
...
arch_item1 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/wood-windows.jpeg')
)
...
arch_item2 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/building.jpeg')
)

arch_item3 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/circular-tower.jpeg')
)

arch_item4 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/curvy-building.jpeg')
)

arch_item5 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/glass-windows.jpeg')
)

arch_item6 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/spiral-thing.jpeg')
)

arch_item7 = Item.create!(
  project_id: arch.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/spiral-staircase.jpeg')
)
# project 3 
...
color_item1 = Item.create!(
  project_id: color.id, 
  caption:'Pool', 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/pineapple.jpeg')
)
...
color_item2 = Item.create!(
  project_id: color.id, 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/paper.png')
)

color_item3 = Item.create!(
  project_id: color.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/purple-smoke.jpeg')
)

color_item4 = Item.create!(
  project_id: color.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/color-pencils.jpeg')
)

color_item5 = Item.create!(
  project_id: color.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/pexels-crayons.jpeg')
)

color_item6 = Item.create!(
  project_id: color.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/redpaint.jpeg')
)

color_item7 = Item.create!(
  project_id: color.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/rainbow-parachute.jpeg')
)
...
fantasy_item1 = Item.create!(
  ...
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/ufo.jpg')
)
...
fantasy_item2 = Item.create!(
  project_id: fantasy.id, 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/fantasy4.jpg')
)

fantasy_item3 = Item.create!(
  project_id: fantasy.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/fantasy-2.jpg')
)

fantasy_item4 = Item.create!(
  project_id: fantasy.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/book.jpg')
)

fantasy_item5 = Item.create!(
  project_id: fantasy.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/fantasy3.jpg')
)
...
weird_item1 = Item.create!(
  project_id: weird.id, 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/further_future.JPG')
)
...
weird_item2 = Item.create!(
  project_id: weird.id, 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/night-house.jpg')
)

weird_item3 = Item.create!(
  project_id: weird.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/raven.jpg')
)

weird_item4 = Item.create!(
  project_id: weird.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/butterfly-face.jpg')
)

weird_item5 = Item.create!(
  project_id: weird.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/body.jpg')
)

weird_item6 = Item.create!(
  project_id: weird.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/spider-eyes.jpg')
)

weird_item7 = Item.create!(
  project_id: weird.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/umbrella.jpeg')
)
...
landscape_item1 = Item.create!(
  ...
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/california.jpg')
)
...
landscape_item2 = Item.create!(
  project_id: landscape.id, 
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/glacier.jpg')
)

landscape_item3 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/iceland-fox.jpg')
)

landscape_item4 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/iceland.jpg')
)

landscape_item5 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/iceland2.jpg')
)

landscape_item6 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/lake-irene.jpg')
)                                             

landscape_item7 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/mountain-landscape.jpg')
)

landscape_item8 = Item.create!(
  project_id: landscape.id,  
  image:  URI.parse('https://s3-us-west-1.amazonaws.com/app-enchant-dev/dev/images/original/rough-horn.jpg')
)
